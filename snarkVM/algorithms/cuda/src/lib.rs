...
pub fn msm<Affine: std::fmt::Debug, Projective, Scalar: std::fmt::Debug>(points: &[Affine], scalars: &[Scalar]) -> Result<Projective, cuda::Error> {
    ...
    //println!("points_len : {:#?}", points.len());
    //println!("points: {:#?}", points[0]);
    //println!("scalar_len: {:?}", scalars.len());
    //println!("scalars: {:#?}", scalars[0]);


    //println!("cuda::msm: checkpoint_01");
    ...
    //println!("cuda::msm: checkpoint_01..., time: {:?}", difference);
    
    //println!("cuda::msm: checkpoint_02");
    //let sys_time1 = SystemTime::now();
    ...
    //let sys_time2 = SystemTime::now();
    //let difference = sys_time2.duration_since(sys_time1);
    //println!("cuda::msm: ..., time: {:?}", difference);
