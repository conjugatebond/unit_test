...
public:
	...
	//auto start = Clock::now();
        //cout<<"MSM checkpoint_01"<<endl;

	// ngpus() = 0, npoints = 16384     
        size_t gpu_count = min(ngpus(), npoints);

	// partial_sums[gpu_count] = 139836241428912 
	...
	channel_t<size_t> ch;
        ...
        //printf("MSM checkpoint_01: %ld us\n", dt);
        ...
        //printf("Time Consumption = %g ms.\n", elapsed_time);


        //auto end = Clock::now();
        //uint64_t dt = std::chrono::duration_cast<
        //    std::chrono::microseconds>(end - start).count();
        //printf("MSM time consuption::: %ld us\n", dt);


        //auto start2 = Clock::now();
        //cout<<"MSM checkpoint_05"<<endl;

        *out = partial_sums[dev];

        //auto end2 = Clock::now();
        //uint64_t dt2 = std::chrono::duration_cast<
        //    std::chrono::microseconds>(end2 - start2).count();
        //printf("MSM checkpoint_05: %ld us\n", dt2);
